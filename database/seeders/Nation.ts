        ...
        const nations = await NationFactory.with('events', 3, (builder) => {
            ...
            .merge([
                ...
                },
                {
                    ...
                    shortName: 'Stocken',
                    accentColor: '#0073bc',
                    iconImgSrc: 'assets/stockholms-nation.png',
                },
                {
                    oid: 405,
                    ...
                    shortName: 'Norrlands',
                    accentColor: '#e20e17',
                    iconImgSrc: 'assets/norrlandslogga.png',
                },
                {
                    oid: 406,
                    name: 'Kalmar nation',
                    shortName: 'Kalmars',
                    iconImgSrc: 'assets/kalmar.png',
                },
                {
                    oid: 407,
                    name: 'Värmlands nation',
                    shortName: 'Värmlands',
                    iconImgSrc: 'assets/varmlands.jpg',
                },
                {
                    oid: 408,
                    name: 'Gästrike-Hälsinge nation',
                    shortName: "GH's",
                    iconImgSrc: 'assets/gastrikehalsinge.png',
                },
                {
                    oid: 409,
                    name: 'Gotlands nation',
                    shortName: 'Gotlands',
                    iconImgSrc: 'assets/gotlands.png',
                },
                {
                    oid: 410,
                    name: 'Uplands nation',
                    shortName: 'Uplands',
                    iconImgSrc: 'assets/uplands.png',
                },
                {
                    oid: 411,
                    name: 'Östgöta nation',
                    shortName: "ÖG's",
                    iconImgSrc: 'assets/ostgota.png',
                },
                {
                    oid: 412,
                    name: 'Västgöta nation',
                    shortName: "VG's",
                    iconImgSrc: 'assets/vastgota.png',
                },
                {
                    oid: 413,
                    name: 'Smålands nation',
                    shortName: 'Smålands',
                    iconImgSrc: 'assets/smalands.png',
                },
                {
                    oid: 414,
                    name: 'Göteborgs nation',
                    shortName: 'Göteborgs',
                    iconImgSrc: 'assets/gbgNation.png',
                },
                {
                    oid: 415,
                    name: 'Södermanland-Nerikes nation',
                    shortName: 'Snerkes',
                    iconImgSrc: 'assets/snarkes.jpg',
                },
            ])
            .createMany(13)
